 ...
 *
 * */
public class SendMessage81
{
	
	public static String getURL(ShortMessageLog sml) {		
		String URL = "http://220.194.63.59:8030/Submit%20CommandId=123&Name=10655587-t&Pwd=!@IK764&GateName=openet2&ItemId=50101&SpNumber=10655587&UserNumber="+sml.getPhone()+"&UserNumberType=0&FeeType=1&ReportFlag=1&MsgCode=15&msg:="+sml.getContent()+"&ItemType=0&MsgId="+sml.getTime().toString();
		return URL;
	}	
