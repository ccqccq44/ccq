...
public class TestJDBC {
    public static void main(String[] args) throws Exception {
        ...
        String url = "jdbc:mysql://localhost:3306/test?"
                + "user=root&password=&useUnicode=true&characterEncoding=UTF8"; // 2提供JDBC连接的URL 
        try {
            ...
            while(result.next()){												//6处理结果
            	System.out.println("返回的结果1："+result.getString("user_name"));
            	System.out.println("返回的结果2："+result.getString("born_year"));
            }
